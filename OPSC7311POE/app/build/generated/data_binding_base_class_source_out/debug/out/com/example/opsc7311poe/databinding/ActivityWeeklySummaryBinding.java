...
public final class ActivityWeeklySummaryBinding implements ViewBinding {
  ...
  private ActivityWeeklySummaryBinding(@NonNull ConstraintLayout rootView, @NonNull View chooseWeek,
      ...
      @NonNull ImageView imageView, @NonNull ConstraintLayout llCalendar,
      @NonNull ConstraintLayout llHome, @NonNull ConstraintLayout llProfile,
      @NonNull ConstraintLayout llTimer, @NonNull ConstraintLayout main, @NonNull TextView tvBar,
      @NonNull TextView tvCalendar, @NonNull TextView tvHome, @NonNull TextView tvPie,
  ...
  public static ActivityWeeklySummaryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWeeklySummaryBinding((ConstraintLayout) rootView, chooseWeek, clNavBar,
          ibCalendar, ibHome, ibProfile, ibTimer, imageView, llCalendar, llHome, llProfile, llTimer,
          main, tvBar, tvCalendar, tvHome, tvPie, tvProfile, tvSummary, tvTimer, tvgenerate);
    }
