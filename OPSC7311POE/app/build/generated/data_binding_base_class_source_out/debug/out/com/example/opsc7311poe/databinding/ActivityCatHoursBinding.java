...
public final class ActivityCatHoursBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCatHoursBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityCatHoursBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCatHoursBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_cat_hours, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCatHoursBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCatHoursBinding((ConstraintLayout) rootView, btnSelectHours, chooseWeek1,
          clNavBar1, ibCalendar1, ibHome1, ibProfile1, ibTimer1, imageView1, linearLayout1,
          linearLayout21, linearLayout41, linearLayout51, main1, tvCalendar1, tvEndDate1, tvHome1,
          tvProfile1, tvSelectPeriod1, tvStartDate1, tvTimer1, tvTotal, tvgenerate1);
    }
