...
public final class ActivityViewGraphTotalHoursBinding implements ViewBinding {
  ...
  private ActivityViewGraphTotalHoursBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull Button button, @NonNull View chooseWeek,
      @NonNull EditText editTextDate, @NonNull EditText editTextDate2, @NonNull GraphView graf,
  ...
  public static ActivityViewGraphTotalHoursBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.graf;
      GraphView graf = ViewBindings.findChildViewById(rootView, id);
      if (graf == null) {
        break missingId;
      }
      ...
      return new ActivityViewGraphTotalHoursBinding((ConstraintLayout) rootView, bottomNav, button,
          chooseWeek, editTextDate, editTextDate2, graf, imageView, main, textView2, textView3);
    }
