...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.auth
         */
        ...
        /**
         * Returns the group of libraries at google.oauth
         */
    ...
    public static class GoogleAuthLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.auth.library
         */
    ...
    public static class GoogleAuthLibraryLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.auth.library.oauth2
         */
    ...
    public static class GoogleAuthLibraryOauth2LibraryAccessors extends SubDependencyFactory {
        ...
        public GoogleAuthLibraryOauth2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for http (com.google.auth:google-auth-library-oauth2-http)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class GoogleOauthLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.oauth.client
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: googleApiClient (1.31.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: googleApiServicesCalendar (v3-rev305-1.31.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGoogleApiServicesCalendar() { return getVersion("googleApiServicesCalendar"); }

            /**
             * Returns the version associated to this alias: googleAuthLibraryOauth2Http (1.31.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: googleOauthClientJetty (1.31.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
